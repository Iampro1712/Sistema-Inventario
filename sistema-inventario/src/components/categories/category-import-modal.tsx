...
export function CategoryImportModal({ onImportCompleted }: CategoryImportModalProps) {
  ...
  const handleImport = async () => {
    ...
    try {
      ...
      const response = await fetch('/api/categorias/import', {
        method: 'POST',
        body: formData,
      });
      ...
      if (response.ok) {
        ...
        alert(result.error || 'Error al importar categorías');
      }
    } catch (error) {
  ...
  const downloadTemplate = () => {
    const csvContent = `Nombre,Descripción,Color
"Electrónicos","Dispositivos electrónicos y tecnología",#3B82F6
"Accesorios","Accesorios y complementos",#10B981
"Audio","Equipos de audio y sonido",#F59E0B`;
    ...
    <Dialog open={open} onOpenChange={handleOpenChange}>
      ...
      <DialogContent className="sm:max-w-[500px]">
        <DialogHeader>
          ...
          <DialogDescription>
            Carga categorías masivamente desde un archivo CSV.
          </DialogDescription>
        </DialogHeader>
            ...
            <>
              ...
              <div className="bg-blue-50 border border-blue-200 p-3 rounded-lg">
                ...
                <ul className="text-xs text-blue-700 space-y-1">
                  ...
                  <li>• Campo requerido: Nombre</li>
                  <li>• Campos opcionales: Descripción, Color</li>
                  <li>• Color debe ser formato hexadecimal (#RRGGBB)</li>
                  <li>• Los nombres deben ser únicos</li>
                </ul>
              </div>
            ...
            <div className="space-y-4">
              <div className="grid grid-cols-3 gap-4">
                ...
                <div className="bg-orange-50 border border-orange-200 p-3 rounded-lg text-center">
                  ...
                  <p className="text-xs text-orange-700">Omitidas</p>
                </div>
